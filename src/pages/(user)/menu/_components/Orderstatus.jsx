...
export default function OrderStatus({ status }) {
  ...
  switch (status) {
    case 0:
      ...
      text = "Your order is waiting for approval.";
      cancelBtrue = cancelB;
      break;
    case 1:
      className += " alert-success";
      icon = <span className="loading loading-spinner loading-xs"></span>;
      text = "Your order was accepted by the Waiter.";
      cancelBtrue = cancelB;
      break;
    case 2:
      className += "alert-success";
    ...
    case 5:
      ...
      text =
        "Your order is cancelled due to some issues. Ask the waiter for more information";
      break;
    default:
      className = "hidden";
  }
