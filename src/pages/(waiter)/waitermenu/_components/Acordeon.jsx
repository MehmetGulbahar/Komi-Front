    ...
    <option value="3">Desserts</option>
      ...
      <div role="tablist"  className="tabs tabs-bordered  w-full text-wrap">
        <input
          ...
          name="my_tabs_2"
          role="tab"
          className={`hidden sm:block tab ${activeTab === 1 ? "tab-active" : ""} `}
        ...
        <input
          ...
          name="my_tabs_2"
          role="tab"
          className={`hidden sm:block tab ${activeTab === 2 ? "tab-active" : ""}`}
        ...
        <input
          ...
          name="my_tabs_2"
          role="tab"
          className={`hidden sm:block tab ${activeTab === 3 ? "tab-active" : ""}`}
